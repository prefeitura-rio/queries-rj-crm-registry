...
WITH templates AS (
  SELECT DISTINCT templateId FROM {{ source("rj-crm-registry", "fluxo_atendimento_*") }}
...
CASE
  ...
  WHEN templateId IN (7, 8, 12, 17, 24) THEN "prod"
  ELSE NULL
END AS ambiente,
CASE
  WHEN templateId IN (14, 16, 17, 18, 19, 20, 21, 22, 23, 24) THEN "Utilidade"
