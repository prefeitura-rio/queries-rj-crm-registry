...
from (
    ...
    from `rj-crm-registry.brutos_wetalkie_staging.fluxo_atendimento_2025_06`
    union all
    select triggerId, flatTarget, sendDate, deliveryDate, readDate, replyDate, failedDate, faultDescription, status
    from `rj-crm-registry.brutos_wetalkie_staging.fluxo_atendimento_2025_07`
    union all
    select triggerId, flatTarget, sendDate, deliveryDate, readDate, replyDate, failedDate, faultDescription, status
    from `rj-crm-registry.brutos_wetalkie_staging.fluxo_atendimento_2025_08`
)
